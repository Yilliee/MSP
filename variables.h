...
const int Max_Students = 50, Max_Teachers = 10, Max_Admins = 3, Max_Sections = 10, Max_Subjects = 5, Max_Quizzes = 10;
const int STU = 0, TEACH = 1, ADMIN = 2, SECTION = 3, SUBJECTS = 4, QUIZZES = 5, Max_subject_per_teacher = 5,
...
const string Student_Cred_Folder = "Credentials/Sections/", Teacher_Cred_File = "Credentials/Teacher_Creds.txt",
				...
				Subject_Folder = "Subjects/Sections/";
